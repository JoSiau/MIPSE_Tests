...
//        StorageHmatrixComplex hc = new StorageHmatrixComplex(1.0, hFE, 50.0, hIV, null);
            ...
            rh = hc.prod(v);
            rh.sub(rb);
            System.out.println("Erreur after agglo= " + ComplexOperation.norm2(rh) / ComplexOperation.norm2(rb));
            DecompositionMatLab.exit();
            GestionnaireTaches.getGestionnaireTaches().stop();
        } catch (IOException ex) {
            Logger.getLogger(TestComplexAssembly.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
