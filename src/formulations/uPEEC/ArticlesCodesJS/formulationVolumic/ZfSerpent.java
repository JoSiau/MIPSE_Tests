...
public class ZfSerpent {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(ZfSerpent.class.getName()).log(Level.SEVERE, null, ex);
        }
        meshDir += "/src/g2elab/mipse/formulationInProgress";
        ImportFlux mesh = new ImportFlux(meshDir + "/magnetodynamic/U_PEEC_DIELECTRIC/SERPENTDIELEC_3C.DEC");
        //
        // Gather the meshes
        //
        // Conductor
...
//            solP.setPtsDeGaussInductifsVol(64, 27, 27, 16, 9, 9, false);
...
//        solP.setExportTopologie("D:");
        ...
        double ftab[] = new double[30];
        ftab = compteFrequenciesLog(7, 8,ftab.length);
        double imp[] = new double[ftab.length];
        for (int iF = 0; iF < ftab.length; iF++) {
            solP.setVerbose(true);
            double f = ftab[iF];
            /*
