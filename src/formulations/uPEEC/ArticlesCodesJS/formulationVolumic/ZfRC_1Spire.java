...
public class ZfRC_1Spire {
    ...
    public static void main(String[] args) {
        ...
        ImportFlux mesh = new ImportFlux(meshDir + "/magnetodynamic/U_PEEC_DIELECTRIC/ArticlesCodesJS/FormulationVolumique/RC_1SPIRE_BIG.DEC");
        //
        // Gather the meshes
        //
        // Conductor
...
//        solP.setExportTopologie("D:");
        ...
        ftab = compteFrequenciesLog(2, 5, ftab.length);
