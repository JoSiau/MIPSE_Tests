...
//        ftab = compteFrequenciesLog(8, 10, ftab.length);
        ...
        double nbIt[] = new double[ftab.length];
...
//            /*
             ...
             solP.setParamIterativeSolver(1, 10000, -1e-10, 1, -150);
             solP.setParamPreconditionner(2, 500, 0, new double[]{500, -3e-1, 500});
            ...
            String pathPostpro = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/Bobine3Spires/";

            String path_JrealD = pathPostpro + "f" + f + "_d_RE.msh";
            String path_JimD = pathPostpro + "f" + f + "_d_IM.msh";
            String path_JmodD = pathPostpro + "f" + f + "_d_MOD.msh";
            ...
            String path_JrealC = pathPostpro + "f" + f + "_c_RE.msh";
            String path_JimC = pathPostpro + "f" + f + "_c_IM.msh";
            String path_JmodC = pathPostpro + "f" + f + "_c_MOD.msh";
            ...
            String path_Merge = pathPostpro + "f" + f + "_MERGE.msh";
            try {
