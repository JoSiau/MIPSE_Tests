...
//        QuadrangleDroit.setAdaptatif(true);
        ...
        ImportFlux mesh = new ImportFlux(meshDir + "/magnetodynamic/U_PEEC_DIELECTRIC/ArticlesCodesJS/FormulationVolumique/RC_1SPIRE.DEC");
        //
        // Gather the meshes
        //
        // Conductor
        ...
        //
        solP.setPtsDeGaussInductifsVol(15, 4, 4);
...
//        solP.setExportTopologie("D:");
        ...
        try {
            // Save the datas.
            Ecriture saveRes = new Ecriture("D:/jsiau/_Backup_Sources/Resultats/Dielectric/RC_Spire/f" + f + "_RES.out");
            for (int i = 0; i < 2; i++) {
        ...
        String path_JrealD = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/RC_Spire/" + nDof + "f" + f + "_d_RE.msh";
        String path_JimD = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/RC_Spire/" + nDof + "f" + f + "_d_IM.msh";
        String path_JmodD = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/RC_Spire/" + nDof + "f" + f + "_d_MOD.msh";
        ...
        String path_JrealC = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/RC_Spire/" + nDof + "f" + f + "_c_RE.msh";
        String path_JimC = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/RC_Spire/" + nDof + "f" + f + "_c_IM.msh";
        String path_JmodC = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/RC_Spire/" + nDof + "f" + f + "_c_MOD.msh";
        ...
        String path_Merge = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/RC_Spire/" + nDof + "f" + f + "_MERGE.msh";
        try {
