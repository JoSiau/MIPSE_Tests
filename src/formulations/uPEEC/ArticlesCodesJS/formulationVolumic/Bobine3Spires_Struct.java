 ...
 * @author jsiau
 */
public class Bobine3Spires_Struct {
    ...
    public static void main(String[] args) {
        ...
        ImportFlux mesh = new ImportFlux(meshDir + "/magnetodynamic/U_PEEC_DIELECTRIC/ArticlesCodesJS/FormulationVolumique/BOB3SPIRE_LIGHT_STRUCT_NOSYM.DEC");
        //
        // Gather the meshes
        //
        // Conductor
        ...
        //
        solP.setPtsDeGaussInductifsVol(-1, 8, 8);
