...
//        QuadrangleDroit.setAdaptatif(true);
        ...
        try {
            ...
            Logger.getLogger(SerpentSym.class.getName()).log(Level.SEVERE, null, ex);
        }
        meshDir += "/src/g2elab/mipse/formulationInProgress/magnetodynamic/U_PEEC_DIELECTRIC/ArticlesCodesJS/FormulationVolumique/SERP_SYM_VOL_5.DEC";
