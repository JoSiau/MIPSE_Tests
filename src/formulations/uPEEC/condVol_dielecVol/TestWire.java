...
public class TestWire {
    ...
    public static void main(String[] args) {        
        HexaedreDroit.setAdaptatif(false);
        ...
        try {
            ...
            Logger.getLogger(TestWire.class.getName()).log(Level.SEVERE, null, ex);
        }
        meshDir += "/src/g2elab/mipse/formulationInProgress";
        ImportFlux mesh = new ImportFlux(meshDir + "/magnetodynamic/U_PEEC_DIELECTRIC/Cond_n_Dielec_Volumic/WIREON2.DEC");
        //
        // Gather the meshes
        //
        // Conductor
