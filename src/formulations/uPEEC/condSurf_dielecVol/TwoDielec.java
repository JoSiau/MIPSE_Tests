...
public class TwoDielec {
    ...
    public static void main(String[] args) {
        ...
        PEEC_RLMPC_SURF solP = new PEEC_RLMPC_SURF(conductor, bordNull, 1 / 1.68E-8, 35e-6, Dielec, epsilon, borne1, borne2,
                3, false, true);
...
//        /*
         ...
         solP.setParamPreconditionner(0, 500, 0, new double[]{1, -1e4, -1});
        ...
        res.submatrix(0, FSd.getActiveDofCount(), 2, FSc.getActiveDofCount()).scale(1 / 35e-6);
        /*/ // Scale tous les dof
         res.scale(1/ep);
         //*/
        ...
        try {
            // Save the datas.
            Ecriture saveRes = new Ecriture("D:/jsiau/_Backup_Sources/Resultats/Dielectric/Conductor_surface/2D/" + nDof + "f" + f + "_RES.out");
            for (int i = 0; i < 2; i++) {
...
//        System.out.println("P:\n"+solP.getP());
        ...
        String path_JrealD = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/Conductor_surface/2D/" + nDof + "f" + f + "_d_RE.msh";
        String path_JimD = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/Conductor_surface/2D/" + nDof + "f" + f + "_d_IM.msh";
        String path_JmodD = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/Conductor_surface/2D/" + nDof + "f" + f + "_d_MOD.msh";

        ExportGmshHdiv exportJreal = new ExportGmshHdiv(FSd, path_JrealD);

        exportJreal.addQuantity(Jreal_d,
                "Jreal_d");
        ExportGmshHdiv exportJimag = new ExportGmshHdiv(FSd, path_JimD);

        exportJimag.addQuantity(Jimag_d,
                "Jimag_d");
        ...
        exportJreal.addQuantityExportMod(J,
                "Jmod_d");
        ...
        String path_JrealC = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/Conductor_surface/2D/" + nDof + "f" + f + "_c_RE.msh";
        String path_JimC = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/Conductor_surface/2D/" + nDof + "f" + f + "_c_IM.msh";
        String path_JmodC = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/Conductor_surface/2D/" + nDof + "f" + f + "_c_MOD.msh";

        exportJreal = new ExportGmshHdiv(FSc, path_JrealC);

        exportJreal.addQuantity(Jreal_c,
                "Jreal_c");
        exportJimag = new ExportGmshHdiv(FSc, path_JimC);

        exportJimag.addQuantity(Jimag_c,
                "Jimag_c");
        ...
        String path_Merge = "D:/jsiau/_Backup_Sources/Resultats/Dielectric/Conductor_surface/2D/" + nDof + "f" + f + "_MERGE.msh";
