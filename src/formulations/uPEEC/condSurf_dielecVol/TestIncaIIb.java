...
public class TestIncaIIb {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(TestIncaIIb.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        double f = 1e9;
        ImportFlux mesh = new ImportFlux(meshDir + "/magnetodynamic/U_PEEC_DIELECTRIC/IIB.DEC");

        double sigma = 1 / 1.72E-8;
        double epsilon = 1e5 * eps0;
        double ep = 35e-6;

        int ind[] = new int[]{1, 2, 0, 3, 4};
...
//U= 0.002615249496847997 + j* 5.5686438807978914E-5
