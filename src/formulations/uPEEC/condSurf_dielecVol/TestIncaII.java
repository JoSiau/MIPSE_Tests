...
public class TestIncaII {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(TestIncaII.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        double f = 50;
        ImportFlux mesh = new ImportFlux(meshDir + "/magnetodynamic/U_PEEC_DIELECTRIC/II.DEC");

        double sigma = 1 / 1.72E-8;
        double epsilon = 1e5 * eps0;
        double ep = 35e-6;
// 0.0437903962889203 + j* 0.04519446930300318
        int ind[] = new int[]{1, 2, 0};//, 2, 3};
...
//        Exporte la topologie pour voir quels noeuds brancher !
//        solP.setExportTopologie("D:");
//        solP.getTopologie();
        circuitPur.addSourceISimple(nbBranches, 2621, 1907, "Source I", 1.0, 0.0);
...
//        }
        ...
        System.out.println("Exporting the matrix to D:/matII.m");
