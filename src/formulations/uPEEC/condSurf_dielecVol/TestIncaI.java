...
public class TestIncaI {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(TestIncaI.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        double f = 1000;
        ImportFlux mesh = new ImportFlux(meshDir + "/magnetodynamic/U_PEEC_DIELECTRIC/I.DEC");
