...
public class ControlSNAKE {
    ...
    public static void main(String[] args) throws Exception {
        ControlSNAKE c = new ControlSNAKE();

    }

    public ControlSNAKE() throws Exception {
...
//        }
        //* Courbe complete 'light'
         ...
         s[1] = new String[]{"1.001e7", "5e7", "50"};
         s[2] = new String[]{"5.001e7", "1e8", "50"};
         s[3] = new String[]{"1.001e8", "5e8", "50"};
         s[4] = new String[]{"5.001e8", "1e9", "50"};
        ...
        for (int i = 0; i < s.length; i++) {
            ...
            ProcessBuilder processBuilder
                    = new ProcessBuilder(path, "-cp",
                            classpath,
                            ControlSNAKE.class.getName(), s[i][0], s[i][1], s[i][2]);
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    try {
                        ...
                        Logger.getLogger(ControlSNAKE.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }).start();
        }
