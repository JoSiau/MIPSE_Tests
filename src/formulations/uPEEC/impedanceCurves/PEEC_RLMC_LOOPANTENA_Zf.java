 ...
 * @author jsiau
 */
public class PEEC_RLMC_LOOPANTENA_Zf {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Ecriture save = new Ecriture("D:/Zf_rlc_loopantena.txt");
        ...
        for (int j = 0; j < nbF; j++) {
            ...
            ElementSetHomogene mesh = new ElementVolSetHomogene(reg.getElementSet().getElements());

            SurfaceRegion border = (SurfaceRegion) IF.getRegion(1);

            FaceConstraint cons[] = new FaceConstraint[]{new ExternalDriveFaceConstraint(border), new ExternalDriveFaceConstraint(IF.getRegion(2)), new ExternalDriveFaceConstraint(IF.getRegion(3))};
            ...
            solPEEC.setPtsDeGaussCapacitifs(3, 3);
            solPEEC.setRho(2.836e-8);
            solPEEC.setVerbose(false);
...
//
            ...
            circuitPur.addSourceISimple(nbBranches + num0 + num1, C1, C2, "SourceI", 1, 0.0);
            ...
            save.ecrire(ff[j]+" "+Math.hypot(ib[1][2 * iRef], ib[1][2 * iRef + 1])+"\n");
            ...
            if (j == 0) {
                ...
                try {
                    ...
                    Logger.getLogger(PEEC_RLMC_LOOPANTENA_Zf.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
        save.close();
