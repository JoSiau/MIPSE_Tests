 ...
 * @author jsiau
 */
public class PEEC_RLMPC_SNAKE_Zf {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String file = path + "/src/g2elab/mipse/formulationInProgress/magnetodynamic/SERPENTDIELEC_3C_GROS.DEC";
        /*
        ...
        /*/
         ...
         //*/
        Ecriture save = new Ecriture("D:/Zf_snake_rlmpc.txt");
        double ib[][];
        Matrix res;
        PEEC_RLMPC_ConducEquiv solP;
//        VolumeRegion rV[] = new VolumeRegion[1];
        for (int j = 0; j < nbF; j += 2) {
            ...
            rV[1] = (VolumeRegion) Imp.getRegion(1);// Region dielectrique
            // Create the solver
            solP = new PEEC_RLMPC_ConducEquiv(rV, Sigma, (SurfaceRegion) Imp.getRegion(2), (SurfaceRegion) Imp.getRegion(3));
            solP.setPtsDeGaussInductifs(8, 8);
...
//            circuitPur.addSourceUSimple(nbBranches + 1 , 12, 3, "cct", 0, 0);
            ...
            if (j == 0) {
                ...
                File out_file = new File((defaultPath != null ? defaultPath : "D:/jsiau/_Backup_Sources/Resultats/Dielectric") + "/SNAKE/S_Jmod" + f[j] + "_nDof" + Omega.getActiveDofCount() + ".msh");
                File out_file1 = new File((defaultPath != null ? defaultPath : "D:/jsiau/_Backup_Sources/Resultats/Dielectric") + "/SNAKE/S_RE_f" + f[j] + "_nDof" + Omega.getActiveDofCount() + ".msh");
                File out_file2 = new File((defaultPath != null ? defaultPath : "D:/jsiau/_Backup_Sources/Resultats/Dielectric") + "/SNAKE/S_IM_f" + f[j] + "_nDof" + Omega.getActiveDofCount() + ".msh");
                try {
