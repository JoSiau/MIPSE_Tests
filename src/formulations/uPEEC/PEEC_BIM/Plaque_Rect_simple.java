...
import g2elab.mipse.formulationInProgress.magnetodynamic.U_PEEC_DIELECTRIC.ExportGmsh_MI;
 ...
 * @author jsiau
 */
public class Plaque_Rect_simple {
    ...
    public static void main(String[] args) {
        ...
        ImportFlux mesh = new ImportFlux(meshDir + "/magnetodynamic/U_PEEC_DIELECTRIC/Cond_n_Dielec_Surf/G.DEC");
//        ImportFlux mesh = new ImportFlux(meshDir + "/magnetodynamic/U_PEEC_DIELECTRIC/Cond_n_Dielec_Surf/PLAQUE_RECT_SIMPLE.DEC");
...
//        solP.setEquiPot(new int[]{512, 1212});
        ...
        ExportGmsh_MI expMi = new ExportGmsh_MI("d:", fd, (SolveurMaillesIndependantes) solP.getSolveurCircuit());
    ...
    public static void main1(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(Plaque_Rect_simple.class.getName()).log(Level.SEVERE, null, ex);
        }
        meshDir += "/src/g2elab/mipse/formulationInProgress";
