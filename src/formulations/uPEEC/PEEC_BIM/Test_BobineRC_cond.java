 ...
 * @author jsiau
 */
public class Test_BobineRC_cond {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(Test_BobineRC_cond.class.getName()).log(Level.SEVERE, null, ex);
        }
        meshDir += "/src/g2elab/mipse/formulationInProgress/magnetodynamic/U_PEEC_DIELECTRIC/ArticlesCodesJS/FormulationVolumique/RC_1SPIRE.DEC";
