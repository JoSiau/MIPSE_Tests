 ...
 * @author jsiau
 */
public class ConductorSolution {
...
//        meshDir = meshDir + "/src/g2elab/mipse/formulationInProgress/magnetodynamic/U_PEEC_DIELECTRIC/LOOPANTENNA_DIELEC_VOL.DEC";
        meshDir = "d:/LA_EXT.DEC";
        ImportFlux mesh = new ImportFlux(meshDir);//SNAKE_CVDS_WB  LOOPANTENNA_SURF3
        /*
         *******************************
         ***  Import du fichier Flux ***
        ...
        PEEC_FULLY_SURF solP = new PEEC_FULLY_SURF((VolumeRegion) mesh.getRegion(0), 1 / 1.68e-8, ep,
                /*
                 ...
                 (SurfaceRegion) mesh.getRegion(1));
                 /*/
//                (SurfaceRegion) mesh.getRegion(3), (SurfaceRegion) mesh.getRegion(2));
                null, null);
        //*/
//        solP.setPtsDeGaussInductifs(25, 9, 9);
        solP.setPtsDeGaussInductifs(15, 5, 5);
        solP.setPtsDeGaussCapacitifs(4, 4);
//        solP.setAnalyticalIntegrationCapa(true);
//        solP.setCorrectionVoisin(true);
