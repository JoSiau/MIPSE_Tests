...
//        path = path + "/src/g2elab/mipse/formulationInProgress/magnetodynamic/FormulationT/PLAQUEL_TRI.DEC";
        path = path + "/src/g2elab/mipse/formulationInProgress/magnetodynamic/FormulationT/PLAQUEL2.DEC";
//       
...
//        sol.setSources(new SourceField[]{srcField});
        ...
        // plaquel
        circuit.addSourceISimple(1000000000,  2497, 2, "Source", 1.0, 0.0);
        // plaque tri
//        circuit.addSourceISimple(1000000000,  103, 7, "Source", 1.0, 0.0);
        circuit.finSaisie();
