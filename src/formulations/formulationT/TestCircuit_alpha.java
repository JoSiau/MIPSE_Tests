...
/**
 * The type Test circuit _ alpha.
 * @author jsiau
 */
public class TestCircuit_alpha {
    ...
    public static void main(String[] args) {
        ...
        path = path + "/src/g2elab/mipse/formulationInProgress/magnetodynamic/FormulationT/CARRE1X1.DEC";
//       
